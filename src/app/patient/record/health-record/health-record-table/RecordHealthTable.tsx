...
import { DataGrid, GridCellParams, GridColDef, GridColumnGroupingModel, GridFilterItem, GridFilterOperator, GridRenderCellParams, GridValueGetterParams, getGridDateOperators } from '@mui/x-data-grid';
import { useSession } from 'next-auth/react';
import { useParams } from 'next/navigation';
import React, { useCallback, useEffect, useState } from 'react'

const RecordHealthTable = ({ params }: { params: { id: string } }) => {
